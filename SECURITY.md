...
- Affected component (installer, system, or a specific part of the desktop) and
  the version, ISO date, or commit.
...
disclosure. Thank you for helping keep Ryoku users safe.
