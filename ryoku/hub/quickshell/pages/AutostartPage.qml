...
Item {
    ...
    Column {
        ...
        Text {
            ...
            text: I18n.tr("Commands your session runs once at login.")
    ...
    Item {
        ...
        Row {
            ...
            Text {
                ...
                text: pg.cmdRows.length === 1 ? I18n.tr("%1 ENTRY").arg(pg.cmdRows.length) : I18n.tr("%1 ENTRIES").arg(pg.cmdRows.length)
