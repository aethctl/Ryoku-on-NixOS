                    ...
                    Column {
                        ...
                        Text {
                            text: Updates.available
                                ? (pg.nixBackend
                                    ? (Updates.behind === 1
                                        ? I18n.tr("%1 version available  ·  checked %2").arg(Updates.behind).arg(Updates.checkedAgo)
                                        : I18n.tr("%1 versions available  ·  checked %2").arg(Updates.behind).arg(Updates.checkedAgo))
                                    : (Updates.behind === 1
